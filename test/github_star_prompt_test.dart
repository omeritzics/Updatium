...
void main() {
  group('GitHubStarPrompt Tests', () {
    ...
    testWidgets('should set first launch date on first initialization', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should not show prompt before 7 days', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should mark prompt as shown when user dismisses', (
      WidgetTester tester,
    ) async {
      ...
      expect(find.text('githubStarPromptTitle'.t()), findsOneWidget);

      // Tap "Don't show again" button
      final dontShowButton = find.text('githubStarPromptDontShowAgain'.t());

...
class TranslationsMs with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String appRemoved({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: 'Removed one app',
	...
	@override String get selectedCategorizeWarning => 'This will replace any existing category settings for selected apps.';
	...
	@override String get sortByLastLinkSegment => 'Sort by only the last segment of link';
	...
	@override String get useSystemFont => 'Use system font';
	...
	@override String get installedVersion => 'Installed';
	@override String get installed => 'Installed';
	@override String get notInstalledApps => 'Tidak dipasang';
	...
	@override String get batteryOptimizationNote => 'Note that background downloads may work more reliably if you switch to "foreground service" in Updatium settings and/or disable battery optimization for Updatium in your OS settings.';
	...
	@override String get fgServiceNotice => 'This notification is required for background update checking (it can be hidden in OS settings)';
	...
	@override String removeAppQuestion({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: 'Remove app?',
		other: 'Remove apps?',
	);
	@override String tooManyRequestsTryAgainInMinutes({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
	...
	@override String bgUpdateGotErrorRetryInMinutes({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
	...
	@override String bgCheckFoundUpdatesWillNotifyIfNeeded({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
	...
	@override String apps({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{count} App',
		other: '{count} Apps',
	);
	@override String url({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{count} URL',
		other: '{count} URLs',
	);
	@override String minute({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{count} minute',
		other: '{count} minutes',
	);
	@override String hour({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{count} hour',
		other: '{count} hours',
	);
	@override String day({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{count} day',
		other: '{count} days',
	);
	@override String clearedNLogsBeforeXAfterY({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: 'Cleared {n} log (before = {before}, after = {after})',
		other: 'Cleared {n} logs (before = {before}, after = {after})',
	);
	@override String xAndNMoreUpdatesAvailable({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{app} and 1 more app have updates.',
		other: '{app} and {count} more apps have updates.',
	);
	@override String xAndNMoreUpdatesInstalled({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{app} and 1 more app was updated.',
		other: '{app} and {count} more apps were updated.',
	);
	@override String xAndNMoreUpdatesFailed({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: 'Failed to update {app} and 1 more app.',
		other: 'Failed to update {app} and {count} more apps.',
	);
	@override String xAndNMoreUpdatesPossiblyInstalled({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{app} and 1 more app may have been updated.',
		other: '{app} and {count} more apps may have been updated.',
	);
	@override String apk({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
		one: '{count} APK',
		other: '{count} APKs',
	);
	@override String certificateHash({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n,
...
extension on TranslationsMs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'appRemoved' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'Removed one app', other: 'Removed {count} apps', ), 
			'updateX' => 'Update {}',
			'installX' => 'Install {}',
			...
			'selectedCategorizeWarning' => 'This will replace any existing category settings for selected apps.',
			...
			'sortByLastLinkSegment' => 'Sort by only the last segment of link',
			...
			'installed' => 'Installed',
			'notInstalledApps' => 'Tidak dipasang',
			'latest' => 'Terbaru',
			...
			'welcome' => 'Welcome',
			'batteryOptimizationNote' => 'Note that background downloads may work more reliably if you switch to "foreground service" in Updatium settings and/or disable battery optimization for Updatium in your OS settings.',
			...
			'fgServiceNotice' => 'This notification is required for background update checking (it can be hidden in OS settings)',
			...
			'removeAppQuestion' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'Remove app?', other: 'Remove apps?', ), 
			'tooManyRequestsTryAgainInMinutes' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'Too many requests (rate limited) - try again in {count} minute', other: 'Too many requests (rate limited) - try again in {count} minutes', ), 
			'bgUpdateGotErrorRetryInMinutes' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'BG update checking encountered a {error}, will schedule a retry check in {count} minute', other: 'BG update checking encountered a {error}, will schedule a retry check in {count} minutes', ), 
			'bgCheckFoundUpdatesWillNotifyIfNeeded' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'BG update checking found {count} update - will notify user if needed', other: 'BG update checking found {count} updates - will notify user if needed', ), 
			'apps' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{count} App', other: '{count} Apps', ), 
			'url' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{count} URL', other: '{count} URLs', ), 
			'minute' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{count} minute', other: '{count} minutes', ), 
			'hour' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{count} hour', other: '{count} hours', ), 
			'day' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{count} day', other: '{count} days', ), 
			'clearedNLogsBeforeXAfterY' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'Cleared {n} log (before = {before}, after = {after})', other: 'Cleared {n} logs (before = {before}, after = {after})', ), 
			'xAndNMoreUpdatesAvailable' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{app} and 1 more app have updates.', other: '{app} and {count} more apps have updates.', ), 
			'xAndNMoreUpdatesInstalled' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{app} and 1 more app was updated.', other: '{app} and {count} more apps were updated.', ), 
			'xAndNMoreUpdatesFailed' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'Failed to update {app} and 1 more app.', other: 'Failed to update {app} and {count} more apps.', ), 
			'xAndNMoreUpdatesPossiblyInstalled' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{app} and 1 more app may have been updated.', other: '{app} and {count} more apps may have been updated.', ), 
			'apk' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: '{count} APK', other: '{count} APKs', ), 
			'certificateHash' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ms'))(n, one: 'Certificate Hash', other: 'Certificate Hashes', ), 

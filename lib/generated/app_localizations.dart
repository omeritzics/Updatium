...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'{p0} will be removed from Updatium but remain installed on device.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Mark {p0} selected apps as updated?'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The app source is \'{p0}\' but the release package comes from \'{p1}\'. Continue?'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{p0} was removed due to this error: {p1}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{p0} needs additional credentials (in Settings)'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{p0} may have been updated to {p1}.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The \"{p0}\" dropdown can be used to reach self-hosted/custom instances of any source.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Failed to delete file (try deleting it manually then try again): \"{p0}\"'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{Remove app?} other{Remove apps?}}'**
  String removeAppQuestion(num count);

  /// No description provided for @tooManyRequestsTryAgainInMinutes.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{Too many requests (rate limited) - try again in {count} minute} other{Too many requests (rate limited) - try again in {count} minutes}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{BG update checking found {count} update - will notify user if needed} other{BG update checking found {count} updates - will notify user if needed}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{{count} URL} other{{count} URLs}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{Cleared {n} log (before = {before}, after = {after})} other{Cleared {n} logs (before = {before}, after = {after})}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{{count} APK} other{{count} APKs}}'**
  String apk(num count);

  /// No description provided for @certificateHash.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{Certificate Hash} other{Certificate Hashes}}'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'bs', 'ca', 'cs', 'da', 'de', 'en', 'es', 'et', 'fa', 'fr', 'gl', 'he', 'hu', 'id', 'it', 'ja', 'ko', 'ml', 'nl', 'pl', 'pt', 'ru', 'sv', 'tr', 'uk', 'vi', 'zh'].contains(locale.languageCode);
...
AppLocalizations lookupAppLocalizations(Locale locale) {
  ...
  switch (locale.countryCode) {
    case 'EO': return AppLocalizationsEnEo();
   }
  break;
   }
    case 'pt': {

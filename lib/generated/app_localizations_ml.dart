...
class AppLocalizationsMl extends AppLocalizations {
  ...
  String invalidURLForSource(Object p0) {
    return 'ഒരു സാധുവായ $p0 ആപ്പ് URL അല്ല';
  }
  ...
  @override
  String get urlMatchesNoSource => 'URL അറിയപ്പെടുന്ന ഒരു ഉറവിടവുമായും യോജിക്കുന്നില്ല';

  @override
  String get cantInstallOlderVersion => 'ആപ്പിന്റെ പഴയ പതിപ്പ് ഇൻസ്റ്റാൾ ചെയ്യാൻ കഴിയില്ല.';

  @override
  String get appIdMismatch => 'ഡൗൺലോഡ് ചെയ്ത പാക്കേജ് ഐഡി നിലവിലുള്ള ആപ്പ് ഐഡിയുമായി ചേരുന്നില്ല';

  @override
  String get functionNotImplemented => 'ഈ ക്ലാസ് ഈ ഫംഗ്ഷൻ നടപ്പിലാക്കിയിട്ടില്ല';
  ...
  @override
  String get githubPATLabel => 'GitHub പേഴ്സണൽ ആക്സസ് ടോക്കൺ (നിരക്ക് പരിധി വർദ്ധിപ്പിക്കുന്നു)';
  ...
  @override
  String get filterReleaseTitlesByRegEx => 'റിലീസ് ശീർഷകങ്ങൾ റെഗുലർ എക്സ്പ്രഷൻ ഉപയോഗിച്ച് ഫിൽട്ടർ ചെയ്യുക';
  ...
  @override
  String get continue => 'തുടരുക';

  @override
  String get requiredInBrackets => '(ആവശ്യമാണ്)';

  @override
  String get dropdownNoOptsError => 'തെറ്റ്: ഡ്രോപ്പ്ഡൗണിന് കുറഞ്ഞത് ഒരു ഓപ്ഷനെങ്കിലും ഉണ്ടായിരിക്കണം';
  ...
  @override
  String get appsFromSourceAreTrackOnly => 'ഈ ഉറവിടത്തിൽ നിന്നുള്ള ആപ്പുകൾ \'ട്രാക്ക്-മാത്രം\' ആണ്.';

  @override
  String get youPickedTrackOnly => 'നിങ്ങൾ \'ട്രാക്ക്-മാത്രം\' ഓപ്ഷൻ തിരഞ്ഞെടുത്തു.';

  @override
  String get trackOnlyAppDescription => 'ആപ്പ് അപ്‌ഡേറ്റുകൾക്കായി ട്രാക്ക് ചെയ്യപ്പെടും, പക്ഷേ ഒബ്‌റ്റേനിയത്തിന് അത് ഡൗൺലോഡ് ചെയ്യാനോ ഇൻസ്റ്റാൾ ചെയ്യാനോ കഴിയില്ല.';
  ...
  @override
  String get alreadyUpToDateQuestion => 'ആപ്പ് ഇതിനകം ഏറ്റവും പുതിയ പതിപ്പിലാണോ?';
  ...
  String additionalOptsFor(Object p0) {
    return '$p0 നായുള്ള അധിക ഓപ്ഷനുകൾ';
  }
  ...
  @override
  String get noAppsSubtext => 'നിങ്ങളുടെ ആദ്യത്തെ ആപ്പ് ചേർക്കാൻ താഴെ \'ആപ്പ് ചേർക്കുക\' ടാപ്പ് ചെയ്യുക.';
  ...
  String deselectX(Object p0) {
    return '$p0 തിരഞ്ഞെടുക്കൽ റദ്ദാക്കുക';
  }

  @override
  String xWillBeRemovedButRemainInstalled(Object p0) {
    return '$p0 ഒബ്‌റ്റേനിയത്തിൽ നിന്ന് നീക്കം ചെയ്യപ്പെടും, പക്ഷേ ഉപകരണത്തിൽ ഇൻസ്റ്റാൾ ചെയ്ത നിലയിൽ തുടരും.';
  }

  @override
  String get removeSelectedAppsQuestion => 'തിരഞ്ഞെടുത്ത ആപ്പുകൾ നീക്കം ചെയ്യണോ?';
  ...
  String updateX(Object p0) {
    return '$p0 അപ്‌ഡേറ്റ് ചെയ്യുക';
  }

  @override
  String installX(Object p0) {
    return '$p0 ഇൻസ്റ്റാൾ ചെയ്യുക';
  }
  ...
  @override
  String get installUpdateApps => 'ആപ്പുകൾ ഇൻസ്റ്റാൾ ചെയ്യുക/അപ്‌ഡേറ്റ് ചെയ്യുക';

  @override
  String get installUpdateSelectedApps => 'തിരഞ്ഞെടുത്ത ആപ്പുകൾ ഇൻസ്റ്റാൾ ചെയ്യുക/അപ്‌ഡേറ്റ് ചെയ്യുക';

  @override
  String markXSelectedAppsAsUpdated(Object p0) {
    return '$p0 തിരഞ്ഞെടുത്ത ആപ്പുകൾ അപ്‌ഡേറ്റ് ചെയ്തതായി അടയാളപ്പെടുത്തണോ?';
  }
  ...
  @override
  String get markSelectedAppsUpdated => 'തിരഞ്ഞെടുത്ത ആപ്പുകൾ അപ്‌ഡേറ്റ് ചെയ്തതായി അടയാളപ്പെടുത്തുക';
  ...
  @override
  String get resetInstallStatusForSelectedAppsQuestion => 'തിരഞ്ഞെടുത്ത ആപ്പുകളുടെ ഇൻസ്റ്റാൾ സ്റ്റാറ്റസ് റീസെറ്റ് ചെയ്യണോ?';

  @override
  String get installStatusOfXWillBeResetExplanation => 'തിരഞ്ഞെടുത്ത ഏതെങ്കിലും ആപ്പുകളുടെ ഇൻസ്റ്റാൾ സ്റ്റാറ്റസ് റീസെറ്റ് ചെയ്യപ്പെടും.\n\nപരാജയപ്പെട്ട അപ്‌ഡേറ്റുകളോ മറ്റ് പ്രശ്നങ്ങളോ കാരണം ഒബ്‌റ്റേനിയത്തിൽ കാണിക്കുന്ന ആപ്പ് പതിപ്പ് തെറ്റായിരിക്കുമ്പോൾ ഇത് സഹായകമാകും.';

  @override
  String get customLinkMessage => 'ഈ ലിങ്കുകൾ ഒബ്‌റ്റേനിയം ഇൻസ്റ്റാൾ ചെയ്ത ഉപകരണങ്ങളിൽ പ്രവർത്തിക്കും';
  ...
  @override
  String get removeOutdatedFilter => 'കാലഹരണപ്പെട്ട ആപ്പ് ഫിൽട്ടർ നീക്കം ചെയ്യുക';
  ...
  String exportedTo(Object p0) {
    return '$p0 ലേക്ക് എക്സ്പോർട്ട് ചെയ്തു';
  }
  ...
  String importedXOfYApps(Object p0, Object p1) {
    return '$p0 ആപ്പുകളിൽ $p1 എണ്ണം ഇംപോർട്ട് ചെയ്തു.';
  }

  @override
  String get followingURLsHadErrors => 'ഇനിപ്പറയുന്ന URL-കളിൽ പിശകുകൾ ഉണ്ടായിരുന്നു:';
  ...
  @override
  String get followSystemThemeExplanation => 'സിസ്റ്റം തീം പിന്തുടരുന്നത് തേർഡ് പാർട്ടി ആപ്ലിക്കേഷനുകൾ ഉപയോഗിച്ച് മാത്രമേ സാധ്യമാകൂ';
  ...
  String appHasMoreThanOnePackage(Object p0) {
    return '$p0-ന് ഒന്നിൽ കൂടുതൽ പാക്കേജുകൾ ഉണ്ട്:';
  }

  @override
  String deviceSupportsXArch(Object p0) {
    return 'നിങ്ങളുടെ ഉപകരണം $p0 CPU ആർക്കിടെക്ചറിനെ പിന്തുണയ്ക്കുന്നു.';
  }

  @override
  String get deviceSupportsFollowingArchs => 'നിങ്ങളുടെ ഉപകരണം ഇനിപ്പറയുന്ന CPU ആർക്കിടെക്ചറുകളെ പിന്തുണയ്ക്കുന്നു:';
  ...
  String sourceIsXButPackageFromYPrompt(Object p0, Object p1) {
    return 'ആപ്പ് ഉറവിടം \'$p0\' ആണ്, പക്ഷേ റിലീസ് പാക്കേജ് \'$p1\'-ൽ നിന്നാണ് വരുന്നത്. തുടരണോ?';
  }
  ...
  @override
  String get updatesAvailableNotifDescription => 'ഒബ്‌റ്റേനിയം ട്രാക്ക് ചെയ്യുന്ന ഒന്നോ അതിലധികമോ ആപ്പുകൾക്ക് അപ്‌ഡേറ്റുകൾ ലഭ്യമാണെന്ന് ഉപയോക്താവിനെ അറിയിക്കുന്നു';
  ...
  String xHasAnUpdate(Object p0) {
    return '$p0-ന് ഒരു അപ്‌ഡേറ്റ് ഉണ്ട്.';
  }
  ...
  @override
  String get appsNotUpdated => 'ആപ്ലിക്കേഷനുകൾ അപ്‌ഡേറ്റ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു';

  @override
  String get appsUpdatedNotifDescription => 'ഒന്നോ അതിലധികമോ ആപ്പുകളിലേക്കുള്ള അപ്‌ഡേറ്റുകൾ ബാക്ക്ഗ്രൗണ്ടിൽ പ്രയോഗിച്ചു എന്ന് ഉപയോക്താവിനെ അറിയിക്കുന്നു';

  @override
  String xWasUpdatedToY(Object p0, Object p1) {
    return '$p0 $p1 ലേക്ക് അപ്‌ഡേറ്റ് ചെയ്തു.';
  }

  @override
  String xWasNotUpdatedToY(Object p0, Object p1) {
    return '$p0 $p1 ലേക്ക് അപ്‌ഡേറ്റ് ചെയ്യാൻ പരാജയപ്പെട്ടു.';
  }
  ...
  @override
  String get errorCheckingUpdatesNotifDescription => 'ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റ് പരിശോധന പരാജയപ്പെടുമ്പോൾ കാണിക്കുന്ന അറിയിപ്പ്';

  @override
  String get appsRemoved => 'ആപ്പുകൾ നീക്കം ചെയ്തു';

  @override
  String get appsRemovedNotifDescription => 'ഒന്നോ അതിലധികമോ ആപ്പുകൾ ലോഡ് ചെയ്യുന്നതിൽ പിശകുകൾ കാരണം നീക്കം ചെയ്തു എന്ന് ഉപയോക്താവിനെ അറിയിക്കുന്നു';

  @override
  String xWasRemovedDueToErrorY(Object p0, Object p1) {
    return '$p0 ഈ പിശക് കാരണം നീക്കം ചെയ്തു: $p1';
  }
  ...
  @override
  String get updatiumMustBeOpenToInstallApps => 'ആപ്പുകൾ ഇൻസ്റ്റാൾ ചെയ്യാൻ ഒബ്‌റ്റേനിയം തുറന്നിരിക്കണം';

  @override
  String get completeAppInstallationNotifDescription => 'ഒരു ആപ്പ് ഇൻസ്റ്റാൾ ചെയ്യുന്നത് പൂർത്തിയാക്കാൻ ഒബ്‌റ്റേനിയത്തിലേക്ക് മടങ്ങാൻ ഉപയോക്താവിനോട് ആവശ്യപ്പെടുന്നു';

  @override
  String get checkingForUpdates => 'അപ്‌ഡേറ്റുകൾ പരിശോധിക്കുന്നു';

  @override
  String get checkingForUpdatesNotifDescription => 'അപ്‌ഡേറ്റുകൾ പരിശോധിക്കുമ്പോൾ ദൃശ്യമാകുന്ന താൽക്കാലിക അറിയിപ്പ്';

  @override
  String get pleaseAllowInstallPerm => 'ആപ്പുകൾ ഇൻസ്റ്റാൾ ചെയ്യാൻ ഒബ്‌റ്റേനിയത്തിന് അനുമതി നൽകുക';
  ...
  @override
  String get versionCorrectionDisabled => 'പതിപ്പ് തിരുത്തൽ പ്രവർത്തനരഹിതമാക്കി (പ്ലഗിൻ പ്രവർത്തിക്കുന്നതായി തോന്നുന്നില്ല)';
  ...
  String latestVersionX(Object p0) {
    return 'ഏറ്റവും പുതിയത്: $p0';
  }

  @override
  String installedVersionX(Object p0) {
    return 'ഇൻസ്റ്റാൾ ചെയ്തത്: $p0';
  }

  @override
  String lastUpdateCheckX(Object p0) {
    return 'അവസാന അപ്‌ഡേറ്റ് പരിശോധന: $p0';
  }
  ...
  @override
  String get appWithIdOrNameNotFound => 'ആ ഐഡിയിലോ പേരിലോ ആപ്പുകളൊന്നും കണ്ടെത്തിയില്ല';

  @override
  String get reposHaveMultipleApps => 'റെപ്പോകളിൽ ഒന്നിലധികം ആപ്പുകൾ അടങ്ങിയിരിക്കാം';
  ...
  @override
  String get disableVersionDetection => 'പതിപ്പ് കണ്ടെത്തൽ പ്രവർത്തനരഹിതമാക്കുക';

  @override
  String get noVersionDetectionExplanation => 'പതിപ്പ് കണ്ടെത്തൽ ശരിയായി പ്രവർത്തിക്കാത്ത ആപ്പുകൾക്ക് മാത്രമേ ഈ ഓപ്ഷൻ ഉപയോഗിക്കാവൂ.';

  @override
  String downloadingX(Object p0) {
    return '$p0 ഡൗൺലോഡ് ചെയ്യുന്നു';
  }

  @override
  String downloadX(Object p0) {
    return '$p0 ഡൗൺലോഡ് ചെയ്യുക';
  }

  @override
  String downloadedX(Object p0) {
    return '$p0 ഡൗൺലോഡ് ചെയ്തു';
  }
  ...
  @override
  String get downloadNotifDescription => 'ഒരു ആപ്പ് ഡൗൺലോഡ് ചെയ്യുന്നതിലെ പുരോഗതി ഉപയോക്താവിനെ അറിയിക്കുന്നു';
  ...
  @override
  String get categoryDeleteWarning => 'ഇല്ലാതാക്കിയ വിഭാഗങ്ങളിലെ എല്ലാ ആപ്പുകളും വിഭാഗരഹിതമായി ക്രമീകരിക്കും.';
  ...
  @override
  String get selectedCategorizeWarning => 'ഇത് തിരഞ്ഞെടുത്ത ആപ്പുകൾക്കായി നിലവിലുള്ള ഏതൊരു വിഭാഗ ക്രമീകരണങ്ങളെയും മാറ്റിസ്ഥാപിക്കും.';

  @override
  String get filterAPKsByRegEx => 'റെഗുലർ എക്സ്പ്രഷൻ ഉപയോഗിച്ച് APK-കൾ ഫിൽട്ടർ ചെയ്യുക';
  ...
  @override
  String get onlyWorksWithNonVersionDetectApps => 'പതിപ്പ് കണ്ടെത്തൽ പ്രവർത്തനരഹിതമാക്കിയ ആപ്പുകൾക്ക് മാത്രമേ ഇത് പ്രവർത്തിക്കൂ.';

  @override
  String get releaseDateAsVersion => 'റിലീസ് തീയതി പതിപ്പ് സ്ട്രിംഗായി ഉപയോഗിക്കുക';

  @override
  String get releaseTitleAsVersion => 'റിലീസ് ശീർഷകം പതിപ്പ് സ്ട്രിംഗായി ഉപയോഗിക്കുക';

  @override
  String get releaseDateAsVersionExplanation => 'പതിപ്പ് കണ്ടെത്തൽ ശരിയായി പ്രവർത്തിക്കാത്തതും എന്നാൽ റിലീസ് തീയതി ലഭ്യമായതുമായ ആപ്പുകൾക്ക് മാത്രമേ ഈ ഓപ്ഷൻ ഉപയോഗിക്കാവൂ.';
  ...
  @override
  String get importFromURLsInFile => 'ഫയലിലെ URL-കളിൽ നിന്ന് ഇംപോർട്ട് ചെയ്യുക (OPML പോലെ)';

  @override
  String get versionDetectionExplanation => 'കണ്ടെത്തിയ പതിപ്പ് സ്ട്രിംഗ് OS-ൽ നിന്ന് കണ്ടെത്തിയ പതിപ്പുമായി പൊരുത്തപ്പെടുത്തുക';
  ...
  @override
  String get autoApkFilterByArch => 'സാധ്യമെങ്കിൽ CPU ആർക്കിടെക്ചർ അനുസരിച്ച് APK-കൾ ഫിൽട്ടർ ചെയ്യാൻ ശ്രമിക്കുക';

  @override
  String get autoLinkFilterByArch => 'സാധ്യമെങ്കിൽ CPU ആർക്കിടെക്ചർ അനുസരിച്ച് ലിങ്കുകൾ ഫിൽട്ടർ ചെയ്യാൻ ശ്രമിക്കുക';
  ...
  @override
  String get dontShowTrackOnlyWarnings => '\'ട്രാക്ക്-മാത്രം\' മുന്നറിയിപ്പുകൾ കാണിക്കരുത്';

  @override
  String get dontShowAPKOriginWarnings => 'APK ഉറവിട മുന്നറിയിപ്പുകൾ കാണിക്കരുത്';

  @override
  String get moveNonInstalledAppsToBottom => 'ഇൻസ്റ്റാൾ ചെയ്യാത്ത ആപ്പുകൾ ആപ്പ് കാഴ്ചയുടെ താഴേക്ക് മാറ്റുക';
  ...
  String requiresCredentialsInSettings(Object p0) {
    return '$p0-ന് അധിക ക്രെഡൻഷ്യലുകൾ ആവശ്യമാണ് (ക്രമീകരണങ്ങളിൽ)';
  }
  ...
  @override
  String get tryInferAppIdFromCode => 'സോഴ്സ് കോഡിൽ നിന്ന് ആപ്പ് ഐഡി അനുമാനിക്കാൻ ശ്രമിക്കുക';

  @override
  String get removeOnExternalUninstall => 'പുറത്ത് നിന്ന് അൺഇൻസ്റ്റാൾ ചെയ്ത ആപ്പുകൾ സ്വയമേവ നീക്കം ചെയ്യുക';

  @override
  String get pickHighestVersionCode => 'ഏറ്റവും ഉയർന്ന പതിപ്പ് കോഡ് APK സ്വയമേവ തിരഞ്ഞെടുക്കുക';

  @override
  String get checkUpdateOnDetailPage => 'ഒരു ആപ്പ് വിശദാംശ പേജ് തുറക്കുമ്പോൾ അപ്‌ഡേറ്റുകൾക്കായി പരിശോധിക്കുക';

  @override
  String get disablePageTransitions => 'പേജ് ട്രാൻസിഷൻ ആനിമേഷനുകൾ പ്രവർത്തനരഹിതമാക്കുക';

  @override
  String get reversePageTransitions => 'പേജ് ട്രാൻസിഷൻ ആനിമേഷനുകൾ വിപരീതമാക്കുക';

  @override
  String get minStarCount => 'കുറഞ്ഞ നക്ഷത്രങ്ങളുടെ എണ്ണം';
  ...
  @override
  String get githubSourceNote => 'API കീ ഉപയോഗിച്ച് GitHub നിരക്ക് പരിധി ഒഴിവാക്കാം.';

  @override
  String get sortByLastLinkSegment => 'ലിങ്കിന്റെ അവസാന ഭാഗം മാത്രം ഉപയോഗിച്ച് അടുക്കുക';

  @override
  String get filterReleaseNotesByRegEx => 'റെഗുലർ എക്സ്പ്രഷൻ ഉപയോഗിച്ച് റിലീസ് നോട്ടുകൾ ഫിൽട്ടർ ചെയ്യുക';

  @override
  String get customLinkFilterRegex => 'റെഗുലർ എക്സ്പ്രഷൻ ഉപയോഗിച്ചുള്ള കസ്റ്റം APK ലിങ്ക് ഫിൽട്ടർ (സ്ഥിരസ്ഥിതി \'.apk\$\')';

  @override
  String get appsPossiblyUpdated => 'ആപ്പ് അപ്‌ഡേറ്റുകൾ ശ്രമിച്ചു';

  @override
  String get appsPossiblyUpdatedNotifDescription => 'ഒന്നോ അതിലധികമോ ആപ്പുകളിലേക്കുള്ള അപ്‌ഡേറ്റുകൾ ബാക്ക്ഗ്രൗണ്ടിൽ പ്രയോഗിക്കാൻ സാധ്യതയുണ്ടെന്ന് ഉപയോക്താവിനെ അറിയിക്കുന്നു';

  @override
  String xWasPossiblyUpdatedToY(Object p0, Object p1) {
    return '$p0 $p1 ലേക്ക് അപ്‌ഡേറ്റ് ചെയ്തിരിക്കാം.';
  }

  @override
  String get enableBackgroundUpdates => 'ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റുകൾ പ്രവർത്തനക്ഷമമാക്കുക';

  @override
  String get backgroundUpdateReqsExplanation => 'എല്ലാ ആപ്പുകൾക്കും ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റുകൾ സാധ്യമായെന്ന് വരില്ല.';

  @override
  String get backgroundUpdateLimitsExplanation => 'ബാക്ക്ഗ്രൗണ്ട് ഇൻസ്റ്റാളിന്റെ വിജയം ഒബ്‌റ്റേനിയം തുറക്കുമ്പോൾ മാത്രമേ നിർണ്ണയിക്കാൻ കഴിയൂ.';

  @override
  String get verifyLatestTag => '\'ഏറ്റവും പുതിയ\' ടാഗ് പരിശോധിക്കുക';

  @override
  String get intermediateLinkRegex => 'സന്ദർശിക്കാൻ ഒരു \'ഇന്റർമീഡിയറ്റ്\' ലിങ്കിനായി ഫിൽട്ടർ ചെയ്യുക';

  @override
  String get filterByLinkText => 'ലിങ്ക് ടെക്സ്റ്റ് ഉപയോഗിച്ച് ലിങ്കുകൾ ഫിൽട്ടർ ചെയ്യുക';
  ...
  @override
  String get exemptFromBackgroundUpdates => 'ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റുകളിൽ നിന്ന് ഒഴിവാക്കുക (പ്രവർത്തനക്ഷമമാക്കിയിട്ടുണ്ടെങ്കിൽ)';

  @override
  String get bgUpdatesOnWiFiOnly => 'വൈഫൈയിൽ അല്ലാത്തപ്പോൾ ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റുകൾ പ്രവർത്തനരഹിതമാക്കുക';

  @override
  String get bgUpdatesWhileChargingOnly => 'ചാർജ് ചെയ്യാത്തപ്പോൾ ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റുകൾ പ്രവർത്തനരഹിതമാക്കുക';

  @override
  String get autoSelectHighestVersionCode => 'ഏറ്റവും ഉയർന്ന versionCode APK സ്വയമേവ തിരഞ്ഞെടുക്കുക';

  @override
  String get versionExtractionRegEx => 'പതിപ്പ് സ്ട്രിംഗ് വേർതിരിച്ചെടുക്കുന്നതിനുള്ള റെഗുലർ എക്സ്പ്രഷൻ';

  @override
  String get trimVersionString => 'റെഗുലർ എക്സ്പ്രഷൻ ഉപയോഗിച്ച് പതിപ്പ് സ്ട്രിംഗ് ട്രിം ചെയ്യുക';

  @override
  String matchGroupToUseForX(Object p0) {
    return '\"$p0\" നായി ഉപയോഗിക്കേണ്ട ഗ്രൂപ്പ് മാച്ച് ചെയ്യുക';
  }

  @override
  String get matchGroupToUse => 'പതിപ്പ് സ്ട്രിംഗ് വേർതിരിച്ചെടുക്കുന്നതിനുള്ള റെഗുലർ എക്സ്പ്രഷനായി ഉപയോഗിക്കേണ്ട ഗ്രൂപ്പ് മാച്ച് ചെയ്യുക';

  @override
  String get highlightTouchTargets => 'കുറഞ്ഞ വ്യക്തതയുള്ള ടച്ച് ടാർഗെറ്റുകൾ ഹൈലൈറ്റ് ചെയ്യുക';

  @override
  String get pickExportDir => 'എക്സ്പോർട്ട് ഡയറക്ടറി തിരഞ്ഞെടുക്കുക';

  @override
  String get autoExportOnChanges => 'മാറ്റങ്ങൾ വരുമ്പോൾ സ്വയമേവ എക്സ്പോർട്ട് ചെയ്യുക';

  @override
  String get includeSettings => 'ക്രമീകരണങ്ങൾ ഉൾപ്പെടുത്തുക';

  @override
  String get filterVersionsByRegEx => 'റെഗുലർ എക്സ്പ്രഷൻ ഉപയോഗിച്ച് പതിപ്പുകൾ ഫിൽട്ടർ ചെയ്യുക';

  @override
  String get trySelectingSuggestedVersionCode => 'നിർദ്ദേശിച്ച versionCode APK തിരഞ്ഞെടുക്കാൻ ശ്രമിക്കുക';

  @override
  String get dontSortReleasesList => 'API-യിൽ നിന്നുള്ള റിലീസ് ഓർഡർ നിലനിർത്തുക';
  ...
  @override
  String get bgTaskStarted => 'ബാക്ക്ഗ്രൗണ്ട് ടാസ്ക് ആരംഭിച്ചു - ലോഗുകൾ പരിശോധിക്കുക.';

  @override
  String get runBgCheckNow => 'ഇപ്പോൾ ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റ് പരിശോധന പ്രവർത്തിപ്പിക്കുക';

  @override
  String get versionExtractWholePage => 'മുഴുവൻ പേജിലും പതിപ്പ് സ്ട്രിംഗ് വേർതിരിച്ചെടുക്കുന്ന റെഗുലർ എക്സ്പ്രഷൻ പ്രയോഗിക്കുക';
  ...
  @override
  String get errorCheckingUpdatesNotifChannel => 'അപ്‌ഡേറ്റുകൾ പരിശോധിക്കുന്നതിൽ പിശക്';
  ...
  @override
  String get completeAppInstallationNotifChannel => 'ആപ്പ് ഇൻസ്റ്റാളേഷൻ പൂർത്തിയാക്കുക';

  @override
  String get checkingForUpdatesNotifChannel => 'അപ്‌ഡേറ്റുകൾ പരിശോധിക്കുന്നു';

  @override
  String get onlyCheckInstalledOrTrackOnlyApps => 'ഇൻസ്റ്റാൾ ചെയ്തതും ട്രാക്ക്-മാത്രം ആപ്പുകളും മാത്രം അപ്‌ഡേറ്റുകൾക്കായി പരിശോധിക്കുക';
  ...
  @override
  String get useShizuku => 'ഇൻസ്റ്റാൾ ചെയ്യാൻ ഷിസുകു അല്ലെങ്കിൽ സ്യൂ ഉപയോഗിക്കുക';
  ...
  @override
  String get shizukuOldAndroidWithADB => 'ആൻഡ്രോയിഡ് < 8.1 ഉള്ള ഷിസുകു ADB ഉപയോഗിച്ച് പ്രവർത്തിക്കുന്നു - ആൻഡ്രോയിഡ് അപ്‌ഡേറ്റ് ചെയ്യുക അല്ലെങ്കിൽ പകരം സ്യൂ ഉപയോഗിക്കുക';

  @override
  String get shizukuPretendToBeGooglePlay => 'Google Play ഇൻസ്റ്റാളേഷൻ ഉറവിടമായി സജ്ജമാക്കുക (ഷിസുകു ഉപയോഗിക്കുകയാണെങ്കിൽ)';

  @override
  String get useSystemFont => 'സിസ്റ്റം ഫോണ്ട് ഉപയോഗിക്കുക';

  @override
  String get useVersionCodeAsOSVersion => 'ആപ്പ് versionCode OS-ൽ കണ്ടെത്തിയ പതിപ്പായി ഉപയോഗിക്കുക';

  @override
  String get requestHeader => 'അഭ്യർത്ഥന തലക്കെട്ട്';

  @override
  String get useLatestAssetDateAsReleaseDate => 'ഏറ്റവും പുതിയ അസറ്റ് അപ്‌ലോഡ് റിലീസ് തീയതിയായി ഉപയോഗിക്കുക';
  ...
  String selfHostedNote(Object p0) {
    return 'ഏത് ഉറവിടത്തിന്റെയും സെൽഫ്-ഹോസ്റ്റ് ചെയ്ത/കസ്റ്റം ഇൻസ്റ്റൻസുകളിലേക്ക് എത്താൻ \"$p0\" ഡ്രോപ്പ്ഡൗൺ ഉപയോഗിക്കാം.';
  }

  @override
  String get badDownload => 'APK പാഴ്സ് ചെയ്യാൻ കഴിഞ്ഞില്ല (അനുയോജ്യമല്ലാത്തതോ ഭാഗികമായ ഡൗൺലോഡോ)';

  @override
  String get beforeNewInstallsShareToAppVerifier => 'പുതിയ ആപ്പുകൾ AppVerifier-ലേക്ക് പങ്കിടുക (ലഭ്യമെങ്കിൽ)';

  @override
  String get appVerifierInstructionToast => 'AppVerifier-ലേക്ക് പങ്കിടുക, തുടർന്ന് തയ്യാറാകുമ്പോൾ ഇവിടെ തിരിച്ചെത്തുക.';
  ...
  @override
  String get stayOneVersionBehind => 'ഏറ്റവും പുതിയ പതിപ്പിന് ഒരു പതിപ്പ് പിന്നിൽ തുടരുക';

  @override
  String get useFirstApkOfVersion => 'ഒന്നിലധികം APK-കളിൽ നിന്ന് ആദ്യത്തേത് സ്വയമേവ തിരഞ്ഞെടുക്കുക';

  @override
  String get refreshBeforeDownload => 'ഡൗൺലോഡ് ചെയ്യുന്നതിന് മുമ്പ് ആപ്പ് വിവരങ്ങൾ പുതുക്കുക';
  ...
  @override
  String get documentationLinksNote => 'താഴെ ലിങ്ക് ചെയ്തിട്ടുള്ള ഒബ്‌റ്റേനിയം GitHub പേജിൽ ആപ്പ് എങ്ങനെ ഉപയോഗിക്കാമെന്ന് മനസ്സിലാക്കാൻ സഹായിക്കുന്ന വീഡിയോകൾ, ലേഖനങ്ങൾ, ചർച്ചകൾ, മറ്റ് വിഭവങ്ങൾ എന്നിവയുടെ ലിങ്കുകൾ അടങ്ങിയിരിക്കുന്നു.';

  @override
  String get batteryOptimizationNote => 'ഒബ്‌റ്റേനിയത്തിനായുള്ള OS ബാറ്ററി ഒപ്റ്റിമൈസേഷനുകൾ പ്രവർത്തനരഹിതമാക്കുകയാണെങ്കിൽ ബാക്ക്ഗ്രൗണ്ട് ഡൗൺലോഡുകൾ കൂടുതൽ വിശ്വസനീയമായി പ്രവർത്തിച്ചേക്കാം എന്നത് ശ്രദ്ധിക്കുക.';

  @override
  String fileDeletionError(Object p0) {
    return 'ഫയൽ ഇല്ലാതാക്കാൻ പരാജയപ്പെട്ടു (സ്വമേധയാ ഇല്ലാതാക്കാൻ ശ്രമിക്കുക, എന്നിട്ട് വീണ്ടും ശ്രമിക്കുക): \"$p0\"';
  }
  ...
  String bgUpdateGotErrorRetryInMinutes(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റ് പരിശോധനയിൽ ഒരു $count നേരിട്ടു, $count മിനിറ്റുകൾക്കുള്ളിൽ വീണ്ടും ശ്രമിക്കാൻ ക്രമീകരിക്കും',
      one: 'ബാക്ക്ഗ്രൗണ്ട് അപ്‌ഡേറ്റ് പരിശോധനയിൽ ഒരു $count നേരിട്ടു, $count മിനിറ്റിനുള്ളിൽ വീണ്ടും ശ്രമിക്കാൻ ക്രമീകരിക്കും',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesAvailable(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count കൂടാതെ $count ആപ്പുകൾക്ക് കൂടി അപ്‌ഡേറ്റുകൾ ലഭ്യമാണ്.',
      one: '$count കൂടാതെ 1 ആപ്പിന് കൂടി അപ്‌ഡേറ്റുകൾ ലഭ്യമാണ്.',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesInstalled(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count കൂടാതെ $count ആപ്പുകൾ കൂടി അപ്‌ഡേറ്റ് ചെയ്തു.',
      one: '$count കൂടാതെ 1 ആപ്പ് കൂടി അപ്‌ഡേറ്റ് ചെയ്തു.',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesFailed(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count കൂടാതെ $count ആപ്പുകൾ കൂടി അപ്‌ഡേറ്റ് ചെയ്യാൻ പരാജയപ്പെട്ടു.',
      one: '$count കൂടാതെ 1 ആപ്പ് കൂടി അപ്‌ഡേറ്റ് ചെയ്യാൻ പരാജയപ്പെട്ടു.',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesPossiblyInstalled(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count കൂടാതെ $count ആപ്പുകൾ കൂടി അപ്‌ഡേറ്റ് ചെയ്തിരിക്കാം.',
      one: '$count കൂടാതെ 1 ആപ്പ് കൂടി അപ്‌ഡേറ്റ് ചെയ്തിരിക്കാം.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get licenseText => 'ഈ അപ്ലിക്കേഷൻ GPL v3 ലൈസൻസിന് കീഴിൽ വിതരണം ചെയ്യുന്നു.';

  @override
  String get disclaimer => 'നിരാകരണം';

  @override
  String get disclaimerText => 'ഈ അപ്ലിക്കേഷൻ ബാഹ്യ അപ്ലിക്കേഷനുകൾ വിതരണം ചെയ്യുന്നില്ല, ഹോസ്റ്റ് ചെയ്യുന്നില്ല, അല്ലെങ്കിൽ പരിശോധിക്കുന്നില്ല. ഈ ടൂൾ ഉപയോഗിച്ച് ഇൻസ്റ്റാൾ ചെയ്യുന്ന ഏത് സോഫ്റ്റ്‌വെയറിന്റെയും സുരക്ഷയ്ക്കും നിയമപരമായ കാര്യങ്ങൾക്കും ഉപയോക്താവ് പൂർണ്ണമായും ഉത്തരവാദിത്തം വഹിക്കുന്നു.';

  @override
  String get privacy => 'സ്വകാര്യത';

  @override
  String get privacyText => 'ഈ ആപ്പ് സ്വകാര്യം പരിഗണിക്കുന്നതും വ്യക്തിഗത ഡാറ്റ ശേഖരിക്കുന്നതുമല്ല.';

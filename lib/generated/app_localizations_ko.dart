...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get trackOnlyAppDescription =>
      '앱은 업데이트를 위해 추적되지만 Updatium은 다운로드하거나 설치할 수 없습니다.';
  ...
  String get updatesAvailableNotifDescription =>
      'Updatium이 추적하는 하나 이상의 앱에 대한 업데이트가 있음을 사용자에게 알립니다';
  ...
  String get appsUpdatedNotifDescription =>
      '백그라운드에서 하나 이상의 앱에 대한 업데이트가 적용되었음을 사용자에게 알립니다';
  ...
  String get appsRemovedNotifDescription =>
      '로드 중 오류로 인해 하나 이상의 앱이 제거되었음을 사용자에게 알립니다';
  ...
  String get completeAppInstallationNotifDescription =>
      '앱 설치를 완료하려면 Updatium으로 돌아가도록 사용자에게 요청합니다';
  ...
  String get noVersionDetectionExplanation =>
      '이 옵션은 버전 감지가 올바르게 작동하지 않는 앱에만 사용해야 합니다.';
  ...
  String get releaseDateAsVersionExplanation =>
      '이 옵션은 버전 감지가 올바르게 작동하지 않지만 릴리스 날짜가 있는 앱에만 사용해야 합니다.';
  ...
  @override
  String get safeMode => '안전 모드';

  @override
  String get safeModeDescription => '앱 추가 페이지를 숨기고 대신 가져오기/내보내기 표시';

  @override
  String get safeModeAddAppDisabled => '앱 추가는 안전 모드에서 비활성화됩니다';

  @override
  String get tryInferAppIdFromCode => '소스 코드에서 앱 ID를 추론해보세요';
  ...
  String get customLinkFilterRegex =>
      '정규 표현식으로 사용자 정의 APK 링크 필터링 (기본값 \'.apk\$\')';
  ...
  String get appsPossiblyUpdatedNotifDescription =>
      '백그라운드에서 하나 이상의 앱에 대한 업데이트가 잠재적으로 적용되었음을 사용자에게 알립니다';
  ...
  String get backgroundUpdateReqsExplanation =>
      '모든 앱에 대해 백그라운드 업데이트가 가능하지 않을 수 있습니다.';

  @override
  String get backgroundUpdateLimitsExplanation =>
      '백그라운드 설치의 성공 여부는 Updatium이 열릴 때만 확인할 수 있습니다.';
  ...
  String get shizukuOldAndroidWithADB =>
      'ADB로 Android < 8.1에서 실행 중인 Shizuku - Android를 업데이트하거나 대신 Sui를 사용하세요';

  @override
  String get shizukuPretendToBeGooglePlay =>
      '설치 소스로 Google Play 설정 (Shizuku 사용 시)';
  ...
  String get beforeNewInstallsShareToAppVerifier =>
      '새 앱을 AppVerifier와 공유 (가능한 경우)';

  @override
  String get appVerifierInstructionToast =>
      'AppVerifier에 공유한 후 준비가 되면 여기로 돌아오세요.';
  ...
  String get documentationLinksNote =>
      '아래에 링크된 Updatium 깃허브 페이지에는 앱 사용 방법을 이해하는 데 도움이 되는 동영상, 기사, 토론 및 기타 리소스에 대한 링크가 포함되어 있습니다.';

  @override
  String get batteryOptimizationNote =>
      'Updatium의 OS 배터리 최적화를 비활성화하면 백그라운드 다운로드가 더 안정적으로 작동할 수 있습니다.';
  ...
  String get foregroundServiceExplanation =>
      '업데이트 확인을 위해 포그라운드 서비스 사용(안정성 향상, 전력 소비량 증가)';
  ...
  String get googleVerificationWarningP2 =>
      'Https://keepandroidopen.org/로 이동하세요.';

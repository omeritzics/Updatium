...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String invalidURLForSource(Object p0) {
    return 'Неверный URL-адрес приложения: $p0';
  }
  ...
  @override
  String get urlMatchesNoSource => 'URL-адрес не соответствует известному источнику';

  @override
  String get cantInstallOlderVersion => 'Невозможно установить более старую версию приложения';

  @override
  String get appIdMismatch => 'ID загруженного пакета не совпадает с существующим ID приложения';
  ...
  @override
  String get githubPATLabel => 'Персональный токен доступа GitHub\n(увеличивает лимит запросов)';
  ...
  @override
  String get filterReleaseTitlesByRegEx => 'Фильтровать заголовки выпусков\n(регулярное выражение)';
  ...
  @override
  String get dropdownNoOptsError => 'Ошибка: в выпадающем списке должна быть выбрана хотя бы одна настройка';
  ...
  @override
  String get wrongArgNum => 'Неправильное количество предоставленных аргументов';

  @override
  String xIsTrackOnly(Object p0) {
    return '$p0 только для отслеживания';
  }
  ...
  @override
  String get appsFromSourceAreTrackOnly => 'Приложения из этого источника настроены только для отслеживания';

  @override
  String get youPickedTrackOnly => 'Выбрана настройка «только для отслеживания»';

  @override
  String get trackOnlyAppDescription => 'Приложение будет отслеживаться на предмет обновлений, но Updatium не сможет загрузить или установить его';
  ...
  String additionalOptsFor(Object p0) {
    return 'Дополнительные настройки для $p0';
  }
  ...
  String deselectX(Object p0) {
    return 'Отменить выбор $p0';
  }

  @override
  String xWillBeRemovedButRemainInstalled(Object p0) {
    return '$p0 будет удалено из Updatium, но останется на устройстве';
  }
  ...
  @override
  String get installUpdateSelectedApps => 'Установить/обновить выбранные приложения';

  @override
  String markXSelectedAppsAsUpdated(Object p0) {
    return 'Выбрано приложений: $p0. Отметить как обновлённые?';
  }
  ...
  @override
  String get markSelectedAppsUpdated => 'Отметить выбранные приложения как обновлённые';
  ...
  @override
  String get resetInstallStatusForSelectedAppsQuestion => 'Сбросить статус установки для выбранных приложений?';

  @override
  String get installStatusOfXWillBeResetExplanation => 'Статус установки для выбранных приложений будет сброшен.\n\nЭто может помочь, если версия приложения, отображаемая в Updatium, некорректная (из-за неудачных обновлений или других проблем).';

  @override
  String get customLinkMessage => 'Эти ссылки работают на устройствах с установленным Updatium';

  @override
  String get shareAppConfigLinks => 'Поделиться конфигурацией приложения в виде HTML-ссылки';

  @override
  String get shareSelectedAppURLs => 'Поделиться URL-адресами выбранных приложений';
  ...
  String importedXOfYApps(Object p0, Object p1) {
    return 'Импортировано приложений: $p0 из $p1';
  }

  @override
  String get followingURLsHadErrors => 'При импорте следующие URL-адреса содержали ошибки:';
  ...
  @override
  String get followSystemThemeExplanation => 'Следование системной теме возможно только при использовании сторонних приложений';
  ...
  @override
  String get bgUpdateCheckInterval => 'Интервал проверки обновлений в фоновом режиме';
  ...
  String appHasMoreThanOnePackage(Object p0) {
    return '$p0 имеет более одного пакета:';
  }

  @override
  String deviceSupportsXArch(Object p0) {
    return 'Ваше устройство поддерживает архитектуру процессора $p0';
  }

  @override
  String get deviceSupportsFollowingArchs => 'Ваше устройство поддерживает следующие архитектуры процессора:';
  ...
  String sourceIsXButPackageFromYPrompt(Object p0, Object p1) {
    return 'Источник приложения — «$p0», но пакет для установки получен из «$p1». Продолжить?';
  }
  ...
  @override
  String get updatesAvailableNotifDescription => 'Уведомляет о наличии обновлений для одного или нескольких приложений в Updatium';
  ...
  @override
  String get appsUpdatedNotifDescription => 'Уведомляет об обновлении одного или нескольких приложений в фоновом режиме';

  @override
  String xWasUpdatedToY(Object p0, Object p1) {
    return '$p0 обновлено до версии $p1';
  }

  @override
  String xWasNotUpdatedToY(Object p0, Object p1) {
    return 'Не удалось обновить $p0 до версии $p1';
  }
  ...
  @override
  String get errorCheckingUpdatesNotifDescription => 'Уведомление о завершении проверки обновлений в фоновом режиме с ошибкой';

  @override
  String get appsRemoved => 'Приложение удалено';

  @override
  String get appsRemovedNotifDescription => 'Уведомление об удалении одного или несколько приложений из-за ошибок при их загрузке';

  @override
  String xWasRemovedDueToErrorY(Object p0, Object p1) {
    return '$p0 удалено из-за ошибки: $p1';
  }
  ...
  @override
  String get updatiumMustBeOpenToInstallApps => 'Updatium должен быть открыт для установки приложений';

  @override
  String get completeAppInstallationNotifDescription => 'Уведомление о необходимости открыть Updatium для завершения установки приложения';

  @override
  String get checkingForUpdates => 'Проверка обновлений';

  @override
  String get checkingForUpdatesNotifDescription => 'Временное уведомление, которое появляется при проверке обновлений';

  @override
  String get pleaseAllowInstallPerm => 'Пожалуйста, разрешите Updatium устанавливать приложения';
  ...
  @override
  String get versionCorrectionDisabled => 'Коррекция версий отключена (плагин, кажется, не работает)';
  ...
  String latestVersionX(Object p0) {
    return 'Последняя версия: $p0';
  }

  @override
  String installedVersionX(Object p0) {
    return 'Установленная версия: $p0';
  }

  @override
  String lastUpdateCheckX(Object p0) {
    return 'Последняя проверка: $p0';
  }
  ...
  @override
  String get appWithIdOrNameNotFound => 'Приложение с таким ID или названием не было найдено';
  ...
  @override
  String get noVersionDetectionExplanation => 'Эта настройка должна использоваться только для приложений, где определение версии не работает корректно';
  ...
  @override
  String get downloadNotifDescription => 'Уведомляет пользователя о прогрессе загрузки приложения';
  ...
  @override
  String get categoryDeleteWarning => 'Все приложения в удалённых категориях будут помечены как «без категории»';
  ...
  @override
  String get selectedCategorizeWarning => 'Это заменит все текущие настройки категорий для выбранных приложений';

  @override
  String get filterAPKsByRegEx => 'Фильтровать APK-файлы\n(регулярное выражение)';
  ...
  @override
  String get onlyWorksWithNonVersionDetectApps => 'Работает только для приложений с отключённым определением версии';

  @override
  String get releaseDateAsVersion => 'Использовать дату выпуска в качестве версии';

  @override
  String get releaseTitleAsVersion => 'Использовать название выпуска в качестве версии';

  @override
  String get releaseDateAsVersionExplanation => 'Эта настройка должна использоваться только для приложений, в которых определение версии не работает правильно, но имеется дата выпуска';
  ...
  @override
  String get importFromURLsInFile => 'Импорт из файла URL-адресов (например: OPML)';

  @override
  String get versionDetectionExplanation => 'Согласовать строку версии с версией, обнаруженной в ОС';
  ...
  @override
  String get autoApkFilterByArch => 'Пытаться фильтровать APK по архитектуре процессора';

  @override
  String get autoLinkFilterByArch => 'Пытаться фильтровать ссылки по архитектуре процессора, если это возможно';
  ...
  @override
  String get dontShowTrackOnlyWarnings => 'Не показывать предупреждения о только отслеживаемых приложениях';

  @override
  String get dontShowAPKOriginWarnings => 'Не показывать предупреждения об отличающемся источнике APK-файлов';

  @override
  String get moveNonInstalledAppsToBottom => 'Показывать неустановленные приложения внизу списка';
  ...
  String requiresCredentialsInSettings(Object p0) {
    return '$p0: для этого требуются дополнительные учётные данные (в настройках)';
  }
  ...
  @override
  String get tryInferAppIdFromCode => 'Пытаться определить ID приложения из исходного кода';

  @override
  String get removeOnExternalUninstall => 'Автоматически убирать из списка удалённые извне приложения';

  @override
  String get pickHighestVersionCode => 'Автовыбор актуальной версии кода APK';

  @override
  String get checkUpdateOnDetailPage => 'Проверять наличие обновлений при открытии страницы приложения';

  @override
  String get disablePageTransitions => 'Отключить анимацию перехода между страницами';

  @override
  String get reversePageTransitions => 'Реверс анимации перехода между страницами';
  ...
  @override
  String get githubSourceNote => 'Используя ключ API, можно обойти ограничение запросов GitHub';

  @override
  String get sortByLastLinkSegment => 'Сортировать только по последнему сегменту ссылки';

  @override
  String get filterReleaseNotesByRegEx => 'Фильтровать примечания к выпуску\n(регулярное выражение)';

  @override
  String get customLinkFilterRegex => 'Пользовательский фильтр ссылок APK\n(регулярное выражение, по умолчанию: «.apk\$»)';

  @override
  String get appsPossiblyUpdated => 'Попытки обновления приложений';

  @override
  String get appsPossiblyUpdatedNotifDescription => 'Уведомление о возможных обновлениях одного или нескольких приложений в фоновом режиме';

  @override
  String xWasPossiblyUpdatedToY(Object p0, Object p1) {
    return '$p0 возможно был обновлён до $p1';
  }
  ...
  @override
  String get backgroundUpdateReqsExplanation => 'Фоновые обновления могут быть возможны не для всех приложений';

  @override
  String get backgroundUpdateLimitsExplanation => 'Успешность фоновой установки можно определить только после открытия Updatium';

  @override
  String get verifyLatestTag => 'Проверять метку «latest»';

  @override
  String get intermediateLinkRegex => 'Фильтр для «промежуточной» ссылки для посещения';
  ...
  @override
  String get exemptFromBackgroundUpdates => 'Исключить из фоновых обновлений (если включено)';

  @override
  String get bgUpdatesOnWiFiOnly => 'Отключить фоновые обновления, если нет подключения к Wi-Fi';

  @override
  String get bgUpdatesWhileChargingOnly => 'Отключить фоновые обновления, если не идёт зарядка';

  @override
  String get autoSelectHighestVersionCode => 'Автовыбор APK с актуальной версией кода';

  @override
  String get versionExtractionRegEx => 'Извлечение версии\n(регулярное выражение)';

  @override
  String get trimVersionString => 'Обрезка строки версии\n(регулярное выражение)';

  @override
  String matchGroupToUseForX(Object p0) {
    return 'Группа соответствия для «$p0»';
  }
  ...
  @override
  String get highlightTouchTargets => 'Выделять менее очевидные элементы управления касанием';
  ...
  @override
  String get filterVersionsByRegEx => 'Фильтровать версии по регулярному выражению';

  @override
  String get trySelectingSuggestedVersionCode => 'Пробовать выбрать предложенный код версии APK';
  ...
  @override
  String get versionExtractWholePage => 'Применить регулярное выражение версии ко всей странице';
  ...
  @override
  String get errorCheckingUpdatesNotifChannel => 'Ошибка при проверке обновлений';
  ...
  @override
  String get completeAppInstallationNotifChannel => 'Завершение установки приложения';

  @override
  String get checkingForUpdatesNotifChannel => 'Проверка обновлений';

  @override
  String get onlyCheckInstalledOrTrackOnlyApps => 'Проверять обновления только у установленных или отслеживаемых приложений';
  ...
  @override
  String get shizukuBinderNotFound => 'Совместимая служба Shizuku не найдена, возможно, она не запущена';

  @override
  String get shizukuOld => 'Устаревшая версия Shizuku (<11), обновите';

  @override
  String get shizukuOldAndroidWithADB => 'Shizuku работает на Android < 8.1 с ADB, обновите Android или используйте Sui';

  @override
  String get shizukuPretendToBeGooglePlay => 'Указывать Google Play как источник установки (если используется Shizuku)';

  @override
  String get useSystemFont => 'Использовать системный шрифт';

  @override
  String get useVersionCodeAsOSVersion => 'Использовать код версии приложения как версию, обнаруженную ОС';

  @override
  String get requestHeader => 'Заголовок запроса';

  @override
  String get useLatestAssetDateAsReleaseDate => 'Использовать последнюю загрузку объекта в качестве даты выпуска';

  @override
  String get defaultPseudoVersioningMethod => 'Метод псевдоверсионирования по умолчанию';
  ...
  String selfHostedNote(Object p0) {
    return 'Выпадающий список «$p0» можно использовать для доступа к самостоятельно размещённым/настроенным экземплярам любого источника.';
  }

  @override
  String get badDownload => 'Не удалось разобрать APK (несовместимая или неполная загрузка)';

  @override
  String get beforeNewInstallsShareToAppVerifier => 'Делиться новыми приложениями с AppVerifier (если доступно)';

  @override
  String get appVerifierInstructionToast => 'Поделитесь с AppVerifier, а затем вернитесь сюда, когда будете готовы.';
  ...
  @override
  String get refreshBeforeDownload => 'Обновлять информацию о приложении перед загрузкой';
  ...
  @override
  String get documentationLinksNote => 'На странице Updatium в GitHub, ссылка на которую приведена ниже, содержатся ссылки на видео, статьи, обсуждения и другие ресурсы, которые помогут вам понять, как пользоваться приложением.';

  @override
  String get batteryOptimizationNote => 'Обратите внимание, что фоновая загрузка может работать более надёжно, если отключить оптимизацию батареи ОС для Updatium.';

  @override
  String fileDeletionError(Object p0) {
    return 'Не удалось удалить файл (попробуйте удалить его вручную, а затем повторите попытку): «$p0»';
  }
  ...
  @override
  String get foregroundServiceExplanation => 'Использовать приоритетную службу для проверки обновлений (надёжнее, энергозатратнее)';

  @override
  String get fgServiceNotice => 'Это уведомление необходимо для фоновой проверки обновлений (оно может быть скрыто в настройках ОС)';

  @override
  String get excludeSecrets => 'Исключить секреты';

  @override
  String get ghReqPrefix => 'Использовать «sky22333/hubproxy» для запросов на GitHub';
  ...
  @override
  String get googleVerificationWarningP1 => 'Google объявил, что начиная с 2026/2027 года, все приложения на сертифицированных устройствах Android потребуют от разработчика предоставления персональных данных непосредственно Google.\n\nПосле этого, Updatium может перестать работать на сертифицированных устройствах Android.';

  @override
  String get googleVerificationWarningP2 => 'Перейдите на https://keepandroidopen.org/ для получения дополнительной информации.';

  @override
  String get googleVerificationWarningP3 => 'Обратите внимание, что в краткосрочной перспективе возможно установить «непроверенные» (не соответствующие) приложения с помощью процесса «продвинутого потока», который Google пообещал реализовать после широкой негативной реакции на их объявление, но они не уточнили, как это будет работать, поэтому неясно, действительно ли данный метод сохранит свободы пользователей каким-либо практическим способом.\n\nВ любом случае, действие Google является значительным шагом к завершению разработки бесплатных приложений сторонними разработчиками.\n\nНесертифицированные ОС, такие как GrapheneOS, не должны быть подвержены этому влиянию до тех пор, пока им разрешено продолжать существовать.';
  ...
  String bgUpdateGotErrorRetryInMinutes(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'При проверке обновлений в фоновом режиме возникла ошибка $count, повторная проверка будет через $count минут',
      one: 'При проверке обновлений в фоновом режиме возникла ошибка $count, повторная проверка будет через $count минуту',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesAvailable(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'У $count и ещё $count приложений есть обновления',
      one: 'У $count и ещё 1 приложения есть обновление',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesInstalled(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count и ещё $count приложений были обновлены',
      one: '$count и ещё 1 приложение были обновлены',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesFailed(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Не удалось обновить $count и ещё $count приложений',
      one: 'Не удалось обновить $count и ещё 1 приложение',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesPossiblyInstalled(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count и ещё $count приложений могли быть обновлены',
      one: '$count и ещё 1 приложение могли быть обновлены',
    );
    return '$_temp0';
  }
  ...
  @override
  String get securityDisclaimerTitle => 'Отказ от ответственности по безопасности и правовым вопросам';

  @override
  String get license => 'Лицензия';

  @override
  String get licenseText => 'Это приложение распространяется под лицензией GPL v3.';

  @override
  String get disclaimer => 'Отказ от ответственности';

  @override
  String get disclaimerText => 'Это приложение не распространяет, не размещает и не проверяет какие-либо внешние приложения. Пользователь несет полную ответственность за безопасность и законность любого программного обеспечения, установленного через этот инструмент.\n\nhttps://github.com/omeritzics/Updatium - это единственное официальное место для загрузки Updatium - настоятельно не рекомендуется загружать его из других мест, поскольку загрузка из неофициальных источников небезопасна.';

  @override
  String get privacy => 'Конфиденциальность';

  @override
  String get privacyText => 'Это приложение ориентировано на конфиденциальность и не собирает личные данные.';

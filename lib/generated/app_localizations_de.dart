...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get urlMatchesNoSource =>
      'URL stimmt mit keiner bekannten Quelle überein';

  @override
  String get cantInstallOlderVersion =>
      'Installation einer älteren App-Version nicht möglich';

  @override
  String get appIdMismatch =>
      'Die heruntergeladene Paket-ID stimmt nicht mit der vorhandenen App-ID überein';

  @override
  String get functionNotImplemented =>
      'Diese Klasse hat diese Funktion nicht implementiert';
  ...
  String get githubPATLabel =>
      'Persönlicher Zugangstoken für GitHub (erhöht das Ratenlimit)';
  ...
  String get dropdownNoOptsError =>
      'FEHLER: DROPDOWN MUSS MINDESTENS EINE OPTION HABEN';
  ...
  String get wrongArgNum =>
      'Falsche Anzahl von Argumenten (Parametern) übermittelt';
  ...
  String get appsFromSourceAreTrackOnly =>
      'Apps aus dieser Quelle sind nur zur Nachverfolgung.';

  @override
  String get youPickedTrackOnly =>
      'Sie haben die Option „Nur nachverfolgen“ gewählt.';

  @override
  String get trackOnlyAppDescription =>
      'Die App wird auf neue verfügbare Versionen überwacht, aber Updatium wird sie nicht herunterladen oder installieren.';
  ...
  String get noAppsSubtext =>
      'Sie können Ihre erste App hinzufügen, indem Sie unten auf \'App hinzufügen\' tippen.';
  ...
  String get installUpdateSelectedApps =>
      'Ausgewählte Apps installieren/aktualisieren';
  ...
  String get markSelectedAppsUpdated =>
      'Ausgewählte Apps als aktuell markieren';
  ...
  String get resetInstallStatusForSelectedAppsQuestion =>
      'Installationsstatus für ausgewählte Apps zurücksetzen?';

  @override
  String get installStatusOfXWillBeResetExplanation =>
      'Der Installationsstatus der ausgewählten Apps wird zurückgesetzt. Dies kann hilfreich sein, wenn die in Updatium angezeigte App-Version aufgrund fehlgeschlagener Aktualisierungen oder anderer Probleme falsch ist.';

  @override
  String get customLinkMessage =>
      'Diese Links funktionieren auf Geräten, wo Updatium installiert ist';
  ...
  String get importedAppsIdDisclaimer =>
      'Importierte Apps werden manchmal fälschlicherweise als „Nicht installiert“ angezeigt. Um dies zu beheben, installieren Sie sie erneut über Updatium. Dies hat keine Auswirkungen auf App-Daten. Es betrifft nur URL- und Drittanbieter-Importmethoden.';
  ...
  String get followSystemThemeExplanation =>
      'Das Abrufen des Systemdesigns ist unter Android < 10 nur mit Hilfe von Drittanbieterapps möglich';
  ...
  String get bgUpdateCheckInterval =>
      'Prüfintervall für Hintergrundaktualisierung';
  ...
  @override
  String get appSourceHint => 'App-Quellcode-Repository öffnen';
  ...
  @override
  String get appLogsHint => 'Anwendungsprotokolle anzeigen';
  ...
  String get deviceSupportsFollowingArchs =>
      'Ihr Gerät unterstützt die folgenden CPU-Architekturen:';
  ...
  String get updatesAvailableNotifDescription =>
      'Benachrichtigt, wenn Aktualisierungen für eine oder mehrere von Updatium überwachte Apps verfügbar sind';
  ...
  String get appsUpdatedNotifDescription =>
      'Benachrichtigt, wenn Aktualisierungen für eine oder mehrere Apps im Hintergrund durchgeführt wurden';
  ...
  String get errorCheckingUpdatesNotifDescription =>
      'Benachrichtigt, wenn die Prüfung der Hintergrundaktualisierung fehlgeschlagen ist';
  ...
  String get appsRemovedNotifDescription =>
      'Benachrichtigt, wenn eine oder mehrere Apps aufgrund von Fehlern beim Laden entfernt wurden';
  ...
  String get updatiumMustBeOpenToInstallApps =>
      'Updatium muss geöffnet sein, um Apps zu installieren';

  @override
  String get completeAppInstallationNotifDescription =>
      'Aufforderung zu Updatium zurückzukehren, um die Installation einer App abzuschließen';
  ...
  String get checkingForUpdatesNotifDescription =>
      'Vorübergehende Benachrichtigung, die bei der Suche nach Aktualisierungen angezeigt wird';

  @override
  String get pleaseAllowInstallPerm =>
      'Bitte erlauben Sie Updatium die Installation von Apps';
  ...
  String get versionCorrectionDisabled =>
      'Versionskorrektur deaktiviert (Plugin scheint nicht zu funktionieren)';
  ...
  String get appWithIdOrNameNotFound =>
      'Es wurde keine App mit dieser ID oder diesem Namen gefunden';
  ...
  String get noVersionDetectionExplanation =>
      'Diese Option sollte nur für Apps verwendet werden, bei denen die Versionserkennung nicht korrekt funktioniert.';
  ...
  String get downloadNotifDescription =>
      'Fortschrittsanzeige beim Herunterladen einer App';
  ...
  String get categoryDeleteWarning =>
      'Alle Apps in gelöschten Kategorien werden auf nicht kategorisiert gesetzt.';
  ...
  String get selectedCategorizeWarning =>
      'Dadurch werden alle bestehenden Kategorieeinstellungen für die ausgewählten Apps ersetzt.';
  ...
  String get onlyWorksWithNonVersionDetectApps =>
      'Funktioniert nur bei Apps mit deaktivierter Versionserkennung.';

  @override
  String get releaseDateAsVersion =>
      'Veröffentlichungsdatum als Version verwenden';

  @override
  String get releaseTitleAsVersion =>
      'Versionstitel als Versionsstring verwenden';

  @override
  String get releaseDateAsVersionExplanation =>
      'Diese Option sollte nur für Apps verwendet werden, bei denen die Versionserkennung nicht korrekt funktioniert, aber ein Veröffentlichungsdatum verfügbar ist.';
  ...
  String get versionDetectionExplanation =>
      'Abgleich der Versionsnummer mit der vom Betriebssystem erkannten Version';
  ...
  String get dontShowTrackOnlyWarnings =>
      'Warnung für ‚Nur nachverfolgen‘ nicht anzeigen';

  @override
  String get dontShowAPKOriginWarnings =>
      'Warnung für APK-Herkunft nicht anzeigen';
  ...
  @override
  String get safeMode => 'Sicherer Modus';

  @override
  String get safeModeDescription =>
      'App hinzufügen-Seite ausblenden und stattdessen Import/Export anzeigen';

  @override
  String get safeModeAddAppDisabled =>
      'App hinzufügen ist im sicheren Modus deaktiviert';

  @override
  String get tryInferAppIdFromCode =>
      'Versuchen, die App-ID aus dem Quellcode zu ermitteln';

  @override
  String get removeOnExternalUninstall =>
      'Extern deinstallierte Apps automatisch entfernen';

  @override
  String get pickHighestVersionCode =>
      'Automatische Auswahl des APK mit höchstem Versionscode';

  @override
  String get checkUpdateOnDetailPage =>
      'Nach Aktualisierungen suchen, wenn eine App-Detailseite geöffnet wird';

  @override
  String get disablePageTransitions =>
      'Animationen für Seitenübergänge deaktivieren';

  @override
  String get reversePageTransitions =>
      'Umgekehrte Animationen für Seitenübergänge';
  ...
  String get addInfoInSettings =>
      'Diese Information in den Einstellungen hinzufügen.';

  @override
  String get githubSourceNote =>
      'Die GitHub-Ratenbegrenzung kann mit einem API-Schlüssel umgangen werden.';

  @override
  String get sortByLastLinkSegment =>
      'Nur nach dem letzten Teil des Links sortieren';
  ...
  String get customLinkFilterRegex =>
      'Benutzerdefinierter APK-Linkfilter durch regulären Ausdruck (Standard \'.apk\$\')';
  ...
  String get appsPossiblyUpdatedNotifDescription =>
      'Benachrichtigt, dass möglicherweise eine oder mehrere Apps im Hintergrund aktualisiert wurden';
  ...
  String get enableBackgroundUpdates =>
      'Hintergrundaktualisierungen aktivieren';

  @override
  String get backgroundUpdateReqsExplanation =>
      'Die Hintergrundaktualisierung ist unter Umständen nicht für alle Apps möglich.';

  @override
  String get backgroundUpdateLimitsExplanation =>
      'Der Erfolg einer Hintergrundinstallation kann nur festgestellt werden, wenn Updatium geöffnet wird.';
  ...
  String get intermediateLinkRegex =>
      'Filter für einen „Zwischen“-Link, der zuerst besucht werden soll';
  ...
  String get exemptFromBackgroundUpdates =>
      'Von Hintergrundaktualisierungen (falls aktiviert) ausschließen';

  @override
  String get bgUpdatesOnWiFiOnly =>
      'Hintergrundaktualisierungen nur im WLAN ausführen';

  @override
  String get bgUpdatesWhileChargingOnly =>
      'Hintergrundaktualisierungen nur ausführen, während das Gerät geladen wird';

  @override
  String get autoSelectHighestVersionCode =>
      'Automatisch höchste APK-Version auswählen';
  ...
  String get highlightTouchTargets =>
      'Weniger offensichtliche Touch-Ziele hervorheben';
  ...
  String get filterVersionsByRegEx =>
      'Versionen nach regulären Ausdrücken filtern';

  @override
  String get trySelectingSuggestedVersionCode =>
      'Versuchen, den vorgeschlagenen APK-Versionscode auszuwählen';
  ...
  String get runBgCheckNow =>
      'Hintergrundaktualisierungsprüfung jetzt durchführen';

  @override
  String get versionExtractWholePage =>
      'Versionsextraktion per RegEx auf die gesamte Seite anwenden';
  ...
  String get skipUpdateNotifications =>
      'Update-Benachrichtigungen überspringen';
  ...
  String get appsPossiblyUpdatedNotifChannel =>
      'App-Aktualisierungen wurden versucht';

  @override
  String get errorCheckingUpdatesNotifChannel =>
      'Fehler beim Prüfen auf Aktualisierungen';
  ...
  String get onlyCheckInstalledOrTrackOnlyApps =>
      'Nur mit „Nur nachverfolgen“ markierte und installierte Apps auf Aktualisierungen prüfen';
  ...
  String get shizukuBinderNotFound =>
      'Kompatibler Shizuku-Dienst wurde nicht gefunden';

  @override
  String get shizukuOld =>
      'Veraltete Shizuku-Version (< 11) – bitte aktualisieren Sie sie';

  @override
  String get shizukuOldAndroidWithADB =>
      'Shizuku läuft auf Android < 8.1 mit ADB – aktualisieren Sie die Android-Version oder verwenden Sie stattdessen Sui';

  @override
  String get shizukuPretendToBeGooglePlay =>
      '(Mittels Shizuku) Google Play als Installationsquelle registrieren';
  ...
  String get useVersionCodeAsOSVersion =>
      'Versionscode (versionCode) als vom Betriebssystem erkannte Version verwenden';
  ...
  String get useLatestAssetDateAsReleaseDate =>
      'Letzten Upload eines Release-Anhangs als Veröffentlichungsdatum verwenden';

  @override
  String get defaultPseudoVersioningMethod =>
      'Standardmäßiges Verfahren zur Pseudo-Versionierung';
  ...
  String get refreshBeforeDownload =>
      'App-Details vor dem Download aktualisieren';
  ...
  String get badDownload =>
      'Die APK konnte nicht gelesen werden (inkompatibler oder unfertiger Download)';

  @override
  String get beforeNewInstallsShareToAppVerifier =>
      'Neue Apps mit AppVerifier teilen (falls verfügbar)';

  @override
  String get appVerifierInstructionToast =>
      'Teile die Daten mit AppVerifier und kehre im Anschluss hierher zurück.';

  @override
  String get wiki => 'Hilfe/Wiki';

  @override
  String get wikiHint => 'Updatium-Wiki-Dokumentation öffnen';
  ...
  String get stayOneVersionBehind =>
      'Eine Version hinter der neuesten Version bleiben';

  @override
  String get useFirstApkOfVersion =>
      'Automatische Auswahl der ersten von mehreren APKs';
  ...
  String get documentationLinksNote =>
      'Die unten verlinkte GitHub-Seite von Updatium enthält Links zu Videos, Artikeln, Diskussionen und anderen Ressourcen, die Ihnen helfen werden, die Verwendung der App zu verstehen.';

  @override
  String get batteryOptimizationNote =>
      'Beachten Sie, dass Downloads im Hintergrund möglicherweise zuverlässiger funktionieren, wenn Sie die Batterieoptimierung des Betriebssystems für Updatium deaktivieren.';
  ...
  String get foregroundServiceExplanation =>
      'Aktualisierungsprüfung im Vordergrund durchführen (zuverlässiger, verbraucht mehr Strom)';

  @override
  String get fgServiceNotice =>
      'Diese Benachrichtigung ist für die Prüfung von Updates im Hintergrund erforderlich (sie kann in den Betriebssystemeinstellungen ausgeblendet werden)';
  ...
  String get googleVerificationWarningP2 =>
      'Weitere Informationen finden Sie unter https://keepandroidopen.org/.';
  ...
  String get securityDisclaimerTitle =>
      'Sicherheits- und Rechtlicher Haftungsausschluss';
  ...
  String get licenseText =>
      'Diese Anwendung wird unter der GPL v3 Lizenz verteilt.';
  ...
  String get privacyText =>
      'Diese App ist datenschutzorientiert und sammelt keine persönlichen Daten.';

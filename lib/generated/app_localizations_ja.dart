...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get trackOnlyAppDescription =>
      'アプリのアップデートは追跡されますが、Updatiumはアプリのダウンロードやインストールはできません。';
  ...
  String get followSystemThemeExplanation =>
      'システムテーマへの追従は、サードパーティのアプリケーションを使用することのみで可能です';
  ...
  String get deviceSupportsFollowingArchs =>
      'お使いのデバイスは、以下のCPUアーキテクチャをサポートしています:';
  ...
  String get appsUpdatedNotifDescription =>
      '1つまたは複数のアプリのアップデートがバックグラウンドで適用されたことをユーザーに通知する';
  ...
  String get appsRemovedNotifDescription =>
      'アプリの読み込み中にエラーが発生したため、1つまたは複数のアプリが削除されたことをユーザーに通知する';
  ...
  String get updatiumMustBeOpenToInstallApps =>
      'アプリをインストールするにはUpdatiumを開く必要があります';

  @override
  String get completeAppInstallationNotifDescription =>
      'アプリのインストールを完了するために、Updatiumに戻る必要があります';
  ...
  String get noVersionDetectionExplanation =>
      'このオプションは、バージョン検出が正しく機能しないアプリにのみ使用する必要があります。';
  ...
  String get selectedCategorizeWarning =>
      'これにより、選択したアプリの既存のカテゴリ設定がすべて置き換えられます。';
  ...
  String get releaseDateAsVersionExplanation =>
      'このオプションは、バージョン検出が正しく機能しないアプリで、リリース日が利用可能な場合にのみ使用する必要があります。';
  ...
  @override
  String get safeModeDescription => 'アプリ追加ページを非表示にし、代わりにインポート/エクスポートを表示';

  @override
  String get safeModeAddAppDisabled => 'アプリ追加はセーフモードで無効になっています';

  @override
  String get tryInferAppIdFromCode => 'ソースコードからアプリIDを推測しようとする';
  ...
  String get appsPossiblyUpdatedNotifDescription =>
      '1つまたは複数のアプリのアップデートがバックグラウンドで適用された可能性があることをユーザーに通知する';
  ...
  String get backgroundUpdateReqsExplanation =>
      'バックグラウンドアップデートは、すべてのアプリで利用できるとは限りません。';

  @override
  String get backgroundUpdateLimitsExplanation =>
      'バックグラウンドアップデートが成功したかどうかは、Updatiumを起動したときにしか判断できません。';
  ...
  String get shizukuOldAndroidWithADB =>
      'ShizukuがAndroid 8.1未満でADBを使用して動作しています - Androidをアップデートするか、代わりにSuiを使用してください';

  @override
  String get shizukuPretendToBeGooglePlay =>
      'Google Playをインストール元として設定する（Shizukuを使用する場合）';
  ...
  String get beforeNewInstallsShareToAppVerifier =>
      'AppVerifierで新しいアプリを共有する（利用可能な場合）';

  @override
  String get appVerifierInstructionToast =>
      'AppVerifierに共有し、準備ができたらここに戻ってください。';
  ...
  String get documentationLinksNote =>
      '以下のリンクにあるUpdatium GitHubページには、ビデオ、記事、ディスカッション、その他のリソースへのリンクがあり、アプリの使い方を理解するのに役立ちます。';

  @override
  String get batteryOptimizationNote =>
      'Updatiumの設定で「フォアグラウンドサービス」に切り替えるか、OSの設定でバッテリー最適化を無効にすると、バックグラウンドダウンロードがより確実に動作するようになります。';
  ...
  String get foregroundServiceExplanation =>
      'アップデート確認にフォアグラウンドサービスを使用する（より信頼性が高いが、より電力を消費する）';

  @override
  String get fgServiceNotice =>
      'この通知は、バックグラウンドでアップデートを確認するために必要です（OSの設定で非表示にできます）。';
  ...
  String get googleVerificationWarningP2 =>
      '詳細については、https://keepandroidopen.org/ をご覧ください。';

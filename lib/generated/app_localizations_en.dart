...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String additionalOptsFor(String appName) {
    return 'Additional options for $appName';
  }
  ...
  String xWillBeRemovedButRemainInstalled(String appName) {
    return '$appName will be removed from Updatium but remain installed on device.';
  }
  ...
  String markXSelectedAppsAsUpdated(String count) {
    return 'Mark $count selected apps as updated?';
  }
  ...
  String importedXOfYApps(String imported, String total) {
    return '$imported of $total apps imported.';
  }
  ...
  String appHasMoreThanOnePackage(String appName) {
    return '$appName has more than one package:';
  }

  @override
  String deviceSupportsXArch(String arch) {
    return 'Your device supports the $arch CPU architecture.';
  }
  ...
  String sourceIsXButPackageFromYPrompt(String source, String package) {
    return 'The app source is \'$source\' but the release package comes from \'$package\'. Continue?';
  }
  ...
  String xWasNotUpdatedToY(String appName, String version) {
    return 'Failed to update $appName to $version.';
  }
  ...
  String xWasRemovedDueToErrorY(String appName, String error) {
    return '$appName was removed due to this error: $error';
  }
  ...
  String downloadX(String appName) {
    return 'Download $appName';
  }

  @override
  String downloadedX(String appName) {
    return 'Downloaded $appName';
  }
  ...
  String requiresCredentialsInSettings(String source) {
    return '$source needs additional credentials (in Settings)';
  }
  ...
  @override
  String get safeModeDescription => 'Hide Add App page and show Import/Export instead';
  ...
  String xWasPossiblyUpdatedToY(String appName, String version) {
    return '$appName may have been updated to $version.';
  }
  ...
  String matchGroupToUseForX(String regexName) {
    return 'Match group to use for \"$regexName\"';
  }
  ...
  String selfHostedNote(String dropdown) {
    return 'The \"$dropdown\" dropdown can be used to reach self-hosted/custom instances of any source.';
  }
  ...
  String fileDeletionError(String filename) {
    return 'Failed to delete file (try deleting it manually then try again): \"$filename\"';
  }
  ...
  @override
  String get removeAppQuestion => 'Remove app?';

  @override
  String tooManyRequestsTryAgainInMinutes(int count) {
    return 'Too many requests (rate limited) - try again in $count minute';
  }

  @override
  String bgUpdateGotErrorRetryInMinutes(String error, int count) {
    return 'BG update checking encountered a $error, will schedule a retry check in $count minute';
  }

  @override
  String bgCheckFoundUpdatesWillNotifyIfNeeded(int count) {
    return 'BG update checking found $count update - will notify user if needed';
  }
  ...
  String clearedNLogsBeforeXAfterY(int n, int before, int after) {
    return 'Cleared $n logs (before = $before, after = $after)';
  }

  @override
  String xAndNMoreUpdatesAvailable(String appName, int count) {
    return '$appName and $count more apps have updates.';
  }

  @override
  String xAndNMoreUpdatesInstalled(String appName, int count) {
    return '$appName and $count more apps were updated.';
  }

  @override
  String xAndNMoreUpdatesFailed(String appName, int count) {
    return 'Failed to update $appName and $count more apps.';
  }

  @override
  String xAndNMoreUpdatesPossiblyInstalled(String appName, int count) {
    return '$appName and $count more apps may have been updated.';
  }
  ...
  @override
  String get certificateHash => 'Certificate Hashes';
  ...
  @override
  String get githubStarPromptContent => 'Updatium is a voluntary, open-source community project developed in my free time. If you\'d like to support the project, please consider starring it on GitHub to help us reach more users and contributors. You won\'t be nudged about this again. Thank you in advance! :)';

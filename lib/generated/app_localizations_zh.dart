...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String xWillBeRemovedButRemainInstalled(Object p0) {
    return '“$p0”将从 Updatium 中删除，但仍安装在您的设备中。';
  }
  ...
  @override
  String get installStatusOfXWillBeResetExplanation => '选中应用的安装状态将会被重置。\n\n当更新安装失败或其他问题导致 Updatium 中的应用版本显示错误时，可以尝试通过此方法解决。';
  ...
  @override
  String get importedAppsIdDisclaimer => '导入的应用可能会错误地显示为“未安装”状态。\n请通过 Updatium 重新安装这些应用来解决此问题。';
  ...
  String sourceIsXButPackageFromYPrompt(Object p0, Object p1) {
    return '此应用的来源是“$p0”，但 APK 文件来自“$p1”。是否继续？';
  }
  ...
  @override
  String get customLinkFilterRegex => '筛选自定义来源的 APK 文件链接\n（正则表达式，默认匹配模式为“.apk\$”）';
  ...
  @override
  String get shizukuOldAndroidWithADB => '正在低版本 Android（<8.1）系统中以 ADB 模式运行 Shizuku - 请更新 Android 系统版本或使用 Sui 代替';

  @override
  String get shizukuPretendToBeGooglePlay => '将安装来源伪装为 Google Play（需要使用 Shizuku）';
  ...
  String selfHostedNote(Object p0) {
    return '可以通过“$p0”下拉菜单来指向任意来源的自托管/自定义实例。';
  }
  ...
  @override
  String get beforeNewInstallsShareToAppVerifier => '通过 AppVerifier 校验新应用（如果可用）';
  ...
  @override
  String get documentationLinksNote => '下方链接的 GitHub 页面中包含关于 Updatium 的视频、文章、讨论及其他资源，可帮助您了解本应用的使用方法。';

  @override
  String get batteryOptimizationNote => '请注意，在设置中切换为“前台服务”，并/或关闭操作系统对 Updatium 的电池优化，可能会让后台下载更稳定。';

  @override
  String fileDeletionError(Object p0) {
    return '删除文件失败（请手动删除后再次尝试）：\"$p0\"';
  }
  ...
  @override
  String get googleVerificationWarningP1 => 'Google宣布,从2026/2027年开始,所有在\"认证\"Android设备上的应用程序都将要求开发者直接向Google提交个人身份细节.\n\n之后,Updatium可能会停止在认证的Android设备上工作.';

  @override
  String get googleVerificationWarningP2 => '详情请访问https://keepandroidopen.org/.';

  @override
  String get googleVerificationWarningP3 => '请注意,在短期内,通过谷歌承诺在广泛反对其公告后实施的\"高级流程\"程序,可能继续安装\"未经验证\"(不符合要求)的应用软件,但他们没有详细说明这将如何运作,因此不清楚它是否会以任何实际方式真正维护用户自由.\n\n无论如何，谷歌的这一举动是朝向个人自由、通用计算结束的重要一步.\n\n未经认证的OS,如GrapheneOS,只要允许继续存在,就不应受到影响.';
  ...
  String xAndNMoreUpdatesInstalled(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '“$count”和另外 $count 个应用已更新。',
      one: '“$count”和另外 1 个应用已更新。',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesFailed(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '“$count”和另外 $count 个应用更新失败。',
      one: '“$count”和另外 1 个应用更新失败。',
    );
    return '$_temp0';
  }
  ...
  String xAndNMoreUpdatesPossiblyInstalled(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '已尝试更新“$count”和另外 $count 个应用。',
      one: '已尝试更新“$count”和另外 1 个应用。',
    );
    return '$_temp0';
  }
...
class AppLocalizationsZhHantTw extends AppLocalizationsZh {
  ...
  @override
  String xWillBeRemovedButRemainInstalled(Object p0) {
    return '$p0 將從 Updatium 中移除，但仍然安裝在裝置上。';
  }
  ...
  @override
  String get installStatusOfXWillBeResetExplanation => '任何選取應用程式的安裝狀態將被重設。\n\n這可以在由於更新失敗或其他問題導致 Updatium 顯示的應用程式版本不正確時有所幫助。';
  ...
  @override
  String get importedAppsIdDisclaimer => '匯入的應用程式可能會錯誤地顯示為「未安裝」。\n要修正此問題，請透過 Updatium 重新安裝它們。\n這不應該影響應用程式資料。\n\n僅影響 URL 和第三方匯入方法。';
  ...
  @override
  String sourceIsXButPackageFromYPrompt(Object p0, Object p1) {
    return '應用程式來源是 「$p0」，但發佈套件來自 「$p1」。要繼續嗎？';
  }
  ...
  @override
  String get updatesAvailableNotifDescription => '通知使用者有一個或多個由 Updatium 追蹤的應用程式有更新';
  ...
  @override
  String get completeAppInstallationNotifDescription => '請使用者回到 Updatium 以完成應用程式安裝';
  ...
  @override
  String get appsPossiblyUpdatedNotifDescription => '通知使用者一個或多個應用程式的更新可能已在背景中套用';
  ...
  @override
  String get backgroundUpdateLimitsExplanation => '背景安裝的成功與否只能在開啟 Updatium 時確定。';
  ...
  @override
  String get shizukuOldAndroidWithADB => 'Shizuku 在 Android 8.1 以下版本使用 ADB 執行 - 請更新 Android 或改用 Sui';

  @override
  String get shizukuPretendToBeGooglePlay => '設定 Google Play 為安裝來源（如果使用 Shizuku）';
  ...
  @override
  String selfHostedNote(Object p0) {
    return '可使用「$p0」下拉選單來存取任何來源的自行託管/自訂執行個體。';
  }
  ...
  @override
  String get beforeNewInstallsShareToAppVerifier => '將新應用程式分享到 AppVerifier（如果可用）';
  ...
  @override
  String get documentationLinksNote => '下方連結的 Updatium GitHub 頁面包含影片、文章、討論及其他資源，能幫助你瞭解如何使用這款應用程式。';

  @override
  String get batteryOptimizationNote => '請注意，若您在 Updatium 的設定中切換至「前景服務」並／或在作業系統設定中為 Updatium 停用電池最佳化功能，背景下載可能會運作得更穩定。';
  ...
  @override
  String get googleVerificationWarningP1 => 'Google 已宣布，自 2026／2027 年起，所有在「通過認證（certified）」的 Android 裝置上執行的應用程式，都必須由開發者直接向 Google 提交個人身分資訊。\n\n之後，Updatium 可能會停止在通過認證的 Android 裝置上運作。';

  @override
  String get googleVerificationWarningP2 => '如需更多資訊，請前往 https://keepandroidopen.org/.';

  @override
  String get googleVerificationWarningP3 => '請注意，從短期來看，Google 表示在其公告引發廣泛反彈後，可能仍可透過其承諾實作的「進階流程（advanced flow）」來安裝「未經驗證」（不符合規範）的應用程式；然而，Google 尚未說明此流程的具體運作方式，因此無法確定它是否能在實務上真正維護使用者的自由。\n\n無論如何，Google 的這項作法，都是朝向終結個人自由、通用運算的一大步。\n\n只要仍被允許持續存在，像 GrapheneOS 這類未通過認證的作業系統，理論上不會受到此政策影響。';

...
import 'package:updatium/providers/apps_provider.dart' show pm;
...
class ExternalInstallerBridge {
  ...
  static const MethodChannel _channel = MethodChannel(
    'io.github.omeritzics.updatium/external_install',
  );
  ...
  Future<String?> _labelFor(String package) async {
    try {
      return await pm.getApplicationLabel(packageName: package);
    } catch (e) {
  ...
  Future<Uint8List?> _iconFor(String package) async {
    try {
      return await pm.getApplicationIcon(packageName: package);
    } catch (e) {
